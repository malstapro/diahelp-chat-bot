...
lms_time_warning = 'Не можна відправити повідомлення у минуле)'
lms_choice_day = 'Оберіть день розсилання:'
lms_choice_hour = 'Оберіть о кторій годині буде розсилання:'
lms_choice_minute = 'Оберіть о кторій хвилині буде розсилання:'
lms_set_time_done = 'Повідомлення буде надіслано {0} о {1}:{2}'
